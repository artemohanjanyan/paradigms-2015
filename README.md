 ...
 * *Простая*
    ...
    * [Исходный код тестов](java/expression/exception/ExceptionsEasyTest.java)
 * *Усложненная*
    ...
    * [Исходный код тестов](java/expression/exception/ExceptionsHardTest.java)
 * *Базовая*
    ...
    * [Исходный код тестов](java/expression/exception/ExceptionsTest.java)
